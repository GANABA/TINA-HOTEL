...
require('admin/includes/mpdf/vendor/autoload.php');
...
if (isset($_GET['gen_pdf']) && isset($_GET['id'])) {
    ...
    $query = "SELECT bo.*,bd.*,uc.email, r.type FROM `booking_order` bo
    ...
    $color_primary = "#000000"; // Noir professionnel
...
";
    ...
    if ($data['booking_status'] == 'cancelled') {
        $table_data .= "
        <tr>
            <td colspan='2'><strong>Montant total:</strong> $data[trans_amount] CFA</td>
        </tr>
    ";
    } else {
        $table_data .= "
