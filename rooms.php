...
<head>
    ...
    <!-- Title -->
    <title><?php echo $settings_r['site_title'] ?> - NOS CHAMBRES</title>
</head>
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mb-2" id="filterDropdown">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3 d-flex align-items-center justify-content-between" style="font-size: 18px;">
                                    <span>VERIFIER LA DISPONIBILITE</span>
                                    <button id="chk_avail_btn" onclick="chk_avail_clear()" class="btn btn-sm shadow-none text-secondary d-none">Réinitialiser</button>
                                </h5>
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3 d-flex align-items-center justify-content-between" style="font-size: 18px;">
                                    ...
                                    <button id="facilities_btn" onclick="facilities_clear()" class="btn btn-sm shadow-none text-secondary d-none">Réinitialiser</button>
                                </h5>
                                <?php
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3 d-flex align-items-center justify-content-between" style="font-size: 18px;">
                                    <span>INVITES</span>
                                    <button id="guests_btn" onclick="guests_clear()" class="btn btn-sm shadow-none text-secondary d-none">Réinitialiser</button>
                                </h5>
                                <div class="d-flex">
                                    <div class="me-3">
