...
if (isset($_GET['fetch_rooms'])) {
    ...
    if ($chk_avail['checkin'] != '' && $chk_avail['checkout'] != '') {
        ...
        if ($checkin_date == $checkout_date) {
            echo "<h3 class='text-center text-danger'>Date Choisi invalide!</h3>";
            exit;
    ...
    //query for room cards and guests filter
    ...
    while ($room_data = mysqli_fetch_assoc($room_res))
    {
        ...
        while ($fac_row = mysqli_fetch_assoc($fac_q))
        {
            ...
            $facilities_data .= "<span class='badge text-bg-light text-wrap me-1 mb-1'>
                        $fac_row[name]
                </span>
            ";
        }
        ...
        if (!$settings_r['shutdown']) {
            ...
            $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm w-100 text-white custum-bg shadow-none mb-2'>Réserver maintenant</button>";
        }
                        ...
                        <div class='card mb-4 border-0 shadow'>
                            <div class='row g-0 p-3 align-items-center'>
                                <div class='col-md-5 mb-lg-0 mb-md-0 mb-3'>
                                    <img src='$room_thum' class='img-fluid rounded'>
                                </div>
    ...
    if ($count_rooms > 0) {
        ...
        echo "<h3 class='text-center text-danger'>Aucune chambre trouvé!</h3>";
    }
}
