...
<head>
    ...
    <!-- Title -->
    <title><?php echo $settings_r['site_title'] ?> - DETAILS CHAMBRE</title>
</head>
                ...
                <div id="roomCarousel" class="carousel slide">
                    <div class="carousel-inner">
                        ...
                        if (mysqli_num_rows($img_q) > 0) {
                            $active_class = 'active';
                            while ($img_res = mysqli_fetch_array($img_q)) {
                ...
                <div class="card mb-4 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        ...
                        if (!$settings_r['shutdown']) {
                            ...
                            echo <<<book
                                <button onclick='checkLoginToBook($login,$room_data[id])' class="btn w-100 text-white custum-bg shadow-none mb-1">Réserver maintenant</button>
                            book;
                        }
