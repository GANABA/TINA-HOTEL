...
function booking_analytics(period=1) {
    ...
    xhr.onload = function () {
        ...
        document.getElementById('total_amt').textContent = data.total_amt+' FCFA';
        
        document.getElementById('active_bookings').textContent = data.active_bookings;
        document.getElementById('active_amt').textContent = data.active_amt+' FCFA';

        document.getElementById('cancelled_bookings').textContent = data.cancelled_bookings;
        document.getElementById('cancelled_amt').textContent = data.cancelled_amt+' FCFA';
    }
